...
class Language(models.Model):
    ...
    bSave = models.CharField(max_length=255, default="Save")
    ...
    cRepeat = models.CharField(max_length=255, default="Repeat")
    cAutoscroll = models.CharField(max_length=255, default="Autoscroll")
